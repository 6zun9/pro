...
<p><kbd><?php echo lang('login_subheading');?></kbd></p>
...
<?php echo form_open("auth/login", 'class="form-horizontal col-md-5 " role="form"');?>
  ...
  <p><div class="form-group"><?php echo form_submit('submit', lang('login_submit_btn'),'class="btn btn-primary-outline"');?></div></p>
  <p><div class="form-group"><h4><span class="label label-info"><a href="forgot_password" ><?php echo lang('login_forgot_password');?></a></span></h4></div></p>
  <p> <div class="form-group"><h4> <span class="label label-info"><a href="<?php echo base_url(); ?>auth/create_user"> add new user?</a></span></h4></div></p>
